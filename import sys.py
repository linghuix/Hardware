...
class MyWidget(QMainWindow, Ui_MainWindow):
    ...
    def receive_data_and_update(self):
        while True:
            # Receive data from the WiFi connection
            data = self.client_socket.recv(8)  # Assuming the data is a 64-bit floating-point number
            value = struct.unpack('d', data)[0]

            # Update the GUI with the received data
            # ...

            # Trigger a repaint to update the figure
            self.update()
...
if __name__ == '__main__':
    ...
    # Start a separate thread or use QTimer to periodically call receive_data_and_update
    # You may want to use threading or asyncio for this purpose
